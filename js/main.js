...
// prevent excution till html page totally load 
$(function() {
    ...
    var viewModal = function() {
        var that = this;
        that.place_photo = ko.observable('https://upload.wikimedia.org/' +
            'wikipedia/commons/8/83/Kaaba_2.JPG');
        ...
        that.showlist = function() {
            that.display('');that.src('');
        };
        that.hidelist = function() {
            that.display('none');
            that.src('img/down.svg');
        };
        ...
        that.gallery = function(data) {
            ...
            $.ajax({
                ...
                'bbb91df830c&per_page=3&extras=url_s&tags=' + data.title,
